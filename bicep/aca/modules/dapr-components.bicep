...
resource secretstoreComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview' = {
...
resource statestoreComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview' = {
  name: 'statestore'
  parent: containerAppsEnvironment
  properties: {
...
resource pubsubComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview' = {
  name: 'pubsub'
  parent: containerAppsEnvironment
  properties: {
...
// Entrycam component
resource entrycamComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview' =  if (useMosquitto) {
  name: 'entrycam'
  parent: containerAppsEnvironment
  properties: {
...
// Exitcam component
resource exitcamComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview'  =  if (useMosquitto) {
  name: 'exitcam'
  parent: containerAppsEnvironment
  properties: {
    componentType: 'bindings.mqtt'
...
//Email component
resource emailComponent 'Microsoft.App/managedEnvironments/daprComponents@2023-05-02-preview' = {
  name: 'sendmail'
  parent: containerAppsEnvironment
  properties: {
