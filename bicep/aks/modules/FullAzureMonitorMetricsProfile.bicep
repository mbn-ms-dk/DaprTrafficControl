...
//    PARAMETERS
// ------------------
@description('The resource id of Azure monitor workspace.')
param azureMonitorWorkspaceResourceId string 
@description('The location of Azure monitor workspace.')
param azureMonitorWorkspaceLocation string
@description('The resource id of the cluster.')
param clusterResourceId string 
@description('The location of the cluster.')
param clusterLocation string
@description('Metrics allow list for labels.')
param metricLabelsAllowlist string = ''
@description('Metrics allow list for annotations.')
param metricAnnotationsAllowList string = ''
@description('Enable Windows recording rules.')
param enableWindowsRecordingRules bool = false
@description('Loction for Grafana.')
param grafanaLocation string
@description('Sku for Grafana.')
param grafanaSku string = 'Standard'
@description('Id to add as admin to Grafana.')
...
//    RESOURCES
// ------------------
resource dce 'Microsoft.Insights/dataCollectionEndpoints@2022-06-01' = if(enableCollectionRules) {
  name: dceName
  location: azureMonitorWorkspaceLocation
  tags: tags
  kind: 'Linux'
  properties: {
    description: 'Data Collection Endpoint for Azure Monitor Metrics Profile (Managed Prometheus)'
  }
}

resource dcr 'Microsoft.Insights/dataCollectionRules@2022-06-01' = if(enableCollectionRules)  {
  name: dcrName
  location: azureMonitorWorkspaceLocation
  tags: tags
  kind: 'Linux'
...
//    MODULES
// ------------------
module azuremonitormetrics_dcra_clusterResourceId 'nested_azuremonitormetrics_dcra_clusterResourceId.bicep' = if(enableCollectionRules) {
...
//    RECORDING RULES
// ------------------
resource nodeRecordingRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' =  if(enableCollectionRules) {
...
resource kubernetesRecordingRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' =  if(enableCollectionRules) {
...
resource nodeRecordingRuleGroupNameWin 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' =  if(enableCollectionRules) {
...
resource nodeAndKubernetesRecordingRuleGroupNameWin 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' =  if(enableCollectionRules) {
...
var grafanaAdminRole = subscriptionResourceId('Microsoft.Authorization/roleDefinitions','22926164-76b3-42b3-bc55-97df8dab3e41')
